...
14. ADD_SCHEDULE : membuat jadwal kegiatan rutin/kuliah ("jadwal matkul web hari senin jam 8 sampai 10", "jadwal meeting tiap kamis jam 9")
15. QUERY_AGENDA : tanya jadwal rutin atau tugas hari ini/besok ("hari ini jadwatchku apa aja?", "besok ada tugas ga?")
16. CHITCHAT : obrolan biasa, salam, pertanyaan di luar keuangan/produktivitas
17. UNKNOWN : pesan tidak dipahami
