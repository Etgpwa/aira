# Asisten Pribadi (Aira) - Architecture
...
- **Fungsi Utama**:
  ...
  - Mengirim pesan ke modul AI (Gemini) untuk mendeteksi intensi (intent) pengguna.
  ...
  - Menjalankan *cron jobs* untuk mengirimkan pengingat tugas atau jadwal.
